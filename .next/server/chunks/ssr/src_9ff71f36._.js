...
"[project]/src/components/features/leads/LeadDashboard.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LeadDashboard() {
    ...
    const recentInteractions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$react$2f$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].interactions.getInteractionAnalytics, {
    ...
    const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const avgHeatScore = totalLeads > 0 ? filteredContacts.reduce((sum, c)=>sum + (c.leadHeatScore || 0), 0) / totalLeads : 0;
        ...
        const heatScoreDistribution = [
            {
                range: '0-5 (Cold)',
                count: filteredContacts.filter((c)=>(c.leadHeatScore || 0) <= 5).length
            },
            {
                range: '6-15 (Warm)',
                count: filteredContacts.filter((c)=>(c.leadHeatScore || 0) >= 6 && (c.leadHeatScore || 0) <= 15).length
            },
            {
                range: '16+ (Hot)',
                count: filteredContacts.filter((c)=>(c.leadHeatScore || 0) >= 16).length
            }
        ];
        ...
        const socialEngagementMetrics = {
            ...
            topPlatforms: Object.entries(recentInteractions.interactionsByPlatform || {}).map(([platform, interactions])=>({
                    platform,
                    interactions
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                metrics.socialEngagementMetrics.topPlatforms.map((platform, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function MetricCard({ title, value, icon, trend, trendDirection, color }) {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            trend && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `flex items-center text-sm ${trendDirection === 'up' ? 'text-green-600' : 'text-red-600'}`,
                                children: [
...
//# sourceMappingURL=src_9ff71f36._.js.map