...
"[project]/src/lib/utils/leadHeatCalculator.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function calculateLeadHeatScore(interactions, config = DEFAULT_SCORING_CONFIG) {
...
function calculateLeadHeatScoreSimple(interactions) {
    ...
    return interactions.reduce((total, interaction)=>{
        const interactionConfig = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INTERACTION_TYPE_OPTIONS"].find((option)=>option.value === interaction.type);
        return total + (interactionConfig?.weight || 0);
    }, 0);
}
function getLeadHeatFromScore(score) {
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEAD_HEAT_THRESHOLDS"].HOT.min) return "HOT";
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEAD_HEAT_THRESHOLDS"].WARM.min) return "WARM";
    return "COLD";
}
...
function getHeatScoreProgress(score) {
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEAD_HEAT_THRESHOLDS"].HOT.min) {
        // HOT: 16+ maps to 75-100%
        const progressInHot = Math.min((score - 16) / 10, 1); // Cap at score 26 for 100%
        return 75 + progressInHot * 25;
    } else if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEAD_HEAT_THRESHOLDS"].WARM.min) {
...
function calculateHeatTrend(currentScore, previousScore) {
    ...
    return {
        ...
        description: difference > 0 ? `Increased by ${Math.round(percentage)}%` : `Decreased by ${Math.round(percentage)}%`
    };
}
}),
"[project]/src/components/features/leads/LeadPipeline.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$leadHeatCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils/leadHeatCalculator.ts [app-ssr] (ecmascript)");
...
function LeadPipeline() {
    ...
    const updateContactStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$react$2f$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].contacts.updateContactStatus);
    ...
    const pipelineData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!allContacts) return PIPELINE_STAGES.map((stage)=>({
                ...stage,
                contacts: []
            }));
        ...
        return PIPELINE_STAGES.map((stage)=>({
                ...stage,
                contacts: filteredContacts.filter((contact)=>contact.status === stage.id).sort((a, b)=>{
    ...
    const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const conversionRate = totalContacts > 0 ? (allContacts?.filter((c)=>c.status === 'CUSTOMER').length || 0) / totalContacts * 100 : 0;
        const avgTimeInPipeline = (()=>{
            // Calculate average time in pipeline from interaction history
            const statusChanges = allContacts?.flatMap((contact)=>contact.lastInteractionAt ? [
                    (Date.now() - contact.lastInteractionAt) / (1000 * 60 * 60 * 24)
                ] : []) || [];
            return statusChanges.length > 0 ? Math.round(statusChanges.reduce((a, b)=>a + b, 0) / statusChanges.length) : 0;
        })();
        const hotLeadsInPipeline = allContacts?.filter((c)=>c.leadHeat === 'HOT' && ![
                'CUSTOMER',
                'LOST'
            ].includes(c.status)).length || 0;
        return {
            totalContacts,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DndContext"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: pipelineData.map((column)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(PipelineColumn, {
                                column: column,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DragOverlay"], {
                        ...
                        children: activeContact ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "rotate-3 scale-105 shadow-xl",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ContactCard, {
...
function PipelineColumn({ column, contacts }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
        ref: setNodeRef,
        className: `${column.color} min-h-[600px] transition-all ${isOver ? 'ring-2 ring-blue-500 ring-opacity-50' : ''}`,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                className: "pb-3",
                children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        contacts.map((contact)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DraggableContactCard, {
                                contact: contact
                            }, contact._id, false, {
                                fileName: "[project]/src/components/features/leads/LeadPipeline.tsx",
                                lineNumber: 413,
...
function DraggableContactCard({ contact }) {
...
function ContactCard({ contact, isDragging = false }) {
    const heatStyles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$leadHeatCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLeadHeatStylesFromScore"])(contact.leadHeatScore || 0);
    const heatEmoji = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$leadHeatCalculator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getHeatEmoji"])(contact.leadHeat);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
        className: `cursor-grab active:cursor-grabbing transition-all duration-200 hover:shadow-md ${isDragging ? 'shadow-2xl scale-105 rotate-2 border-blue-300' : ''}`,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
            className: "p-4",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-3",
...
//# sourceMappingURL=src_242a0206._.js.map