...
function OpportunityCard({ opportunity, isDragging }) {
...
;
;
function KanbanColumn({ id, title, color, opportunities }) {
...
function KanbanBoard({ opportunities }) {
...
//# sourceMappingURL=src_cf0261b2._.js.map