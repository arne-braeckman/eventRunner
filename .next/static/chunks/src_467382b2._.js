...
"[project]/src/lib/utils/leadHeatCalculator.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "calculateHeatTrend": ()=>calculateHeatTrend,
    "calculateLeadHeatScore": ()=>calculateLeadHeatScore,
    "calculateLeadHeatScoreSimple": ()=>calculateLeadHeatScoreSimple,
    "getHeatDescription": ()=>getHeatDescription,
    "getHeatEmoji": ()=>getHeatEmoji,
    "getHeatScoreProgress": ()=>getHeatScoreProgress,
    "getLeadHeatColor": ()=>getLeadHeatColor,
    "getLeadHeatFromScore": ()=>getLeadHeatFromScore,
    "getLeadHeatScoreColor": ()=>getLeadHeatScoreColor,
    "getLeadHeatStyles": ()=>getLeadHeatStyles,
    "getLeadHeatStylesFromScore": ()=>getLeadHeatStylesFromScore
});
...
const heatCalculationCache = new Map();
const CACHE_TTL = 5 * 60 * 1000; // 5 minutes
// Helper function to generate cache key
function getCacheKey(interactions) {
...
const DEFAULT_SCORING_CONFIG = {
    ...
    frequencyBoostThreshold: 3,
    frequencyBoostMultiplier: 1.3
};
function calculateLeadHeatScore(interactions) {
    let config = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : DEFAULT_SCORING_CONFIG;
    ...
    heatCalculationCache.set(cacheKey, {
        result,
        timestamp: Date.now()
    });
...
function calculateLeadHeatScoreSimple(interactions) {
    if (!interactions || interactions.length === 0) return 0;
    return interactions.reduce((total, interaction)=>{
        const interactionConfig = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INTERACTION_TYPE_OPTIONS"].find((option)=>option.value === interaction.type);
        return total + ((interactionConfig === null || interactionConfig === void 0 ? void 0 : interactionConfig.weight) || 0);
    }, 0);
}
function getLeadHeatFromScore(score) {
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEAD_HEAT_THRESHOLDS"].HOT.min) return "HOT";
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEAD_HEAT_THRESHOLDS"].WARM.min) return "WARM";
    return "COLD";
}
function getLeadHeatColor(heat) {
    switch(heat){
        case "HOT":
...
function getLeadHeatScoreColor(score) {
    const heat = getLeadHeatFromScore(score);
    return getLeadHeatColor(heat);
}
function getLeadHeatStyles(heat) {
    switch(heat){
        case "HOT":
            return {
...
function getLeadHeatStylesFromScore(score) {
    const heat = getLeadHeatFromScore(score);
    return getLeadHeatStyles(heat);
}
function getHeatScoreProgress(score) {
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEAD_HEAT_THRESHOLDS"].HOT.min) {
        // HOT: 16+ maps to 75-100%
        const progressInHot = Math.min((score - 16) / 10, 1); // Cap at score 26 for 100%
        return 75 + progressInHot * 25;
    } else if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2f$contact$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LEAD_HEAT_THRESHOLDS"].WARM.min) {
...
function getHeatDescription(heat, score) {
    switch(heat){
        case "HOT":
            return "Hot lead with score ".concat(score, ". High engagement and strong interest.");
        case "WARM":
            return "Warm lead with score ".concat(score, ". Moderate engagement and potential interest.");
        case "COLD":
            return "Cold lead with score ".concat(score, ". Low engagement or new contact.");
        default:
            return "Lead with score ".concat(score, ". Engagement level unknown.");
    }
}
function calculateHeatTrend(currentScore, previousScore) {
    if (previousScore === 0) {
        return {
            trend: 'stable',
            percentage: 0,
    ...
    return {
        ...
        description: difference > 0 ? "Increased by ".concat(Math.round(percentage), "%") : "Decreased by ".concat(Math.round(percentage), "%")
    };
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
"[project]/src/components/features/leads/LeadPipeline.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$thermometer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ThermometerIcon$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/thermometer.js [app-client] (ecmascript) <export default as ThermometerIcon>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$leadHeatCalculator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils/leadHeatCalculator.ts [app-client] (ecmascript)");
...
function LeadPipeline() {
    ...
    const updateContactStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$react$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].contacts.updateContactStatus);
    ...
    const pipelineData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LeadPipeline.useMemo[pipelineData]": ()=>{
            if (!allContacts) return PIPELINE_STAGES.map({
                "LeadPipeline.useMemo[pipelineData]": (stage)=>({
                        ...stage,
                        contacts: []
                    })
            }["LeadPipeline.useMemo[pipelineData]"]);
            ...
            if (filter.heat) {
                filteredContacts = filteredContacts.filter({
                    "LeadPipeline.useMemo[pipelineData]": (c)=>c.leadHeat === filter.heat
                }["LeadPipeline.useMemo[pipelineData]"]);
            }
            if (filter.source) {
                filteredContacts = filteredContacts.filter({
                    "LeadPipeline.useMemo[pipelineData]": (c)=>c.leadSource === filter.source
                }["LeadPipeline.useMemo[pipelineData]"]);
            }
            return PIPELINE_STAGES.map({
                "LeadPipeline.useMemo[pipelineData]": (stage)=>({
                        ...
                        contacts: filteredContacts.filter({
                            "LeadPipeline.useMemo[pipelineData]": (contact)=>contact.status === stage.id
                        }["LeadPipeline.useMemo[pipelineData]"]).sort({
                            "LeadPipeline.useMemo[pipelineData]": (a, b)=>{
    ...
    const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LeadPipeline.useMemo[metrics]": ()=>{
            const totalContacts = (allContacts === null || allContacts === void 0 ? void 0 : allContacts.length) || 0;
            const conversionRate = totalContacts > 0 ? ((allContacts === null || allContacts === void 0 ? void 0 : allContacts.filter({
                "LeadPipeline.useMemo[metrics]": (c)=>c.status === 'CUSTOMER'
            }["LeadPipeline.useMemo[metrics]"]).length) || 0) / totalContacts * 100 : 0;
            const avgTimeInPipeline = ({
                "LeadPipeline.useMemo[metrics].avgTimeInPipeline": ()=>{
                    // Calculate average time in pipeline from interaction history
                    const statusChanges = (allContacts === null || allContacts === void 0 ? void 0 : allContacts.flatMap({
                        "LeadPipeline.useMemo[metrics].avgTimeInPipeline": (contact)=>contact.lastInteractionAt ? [
                                (Date.now() - contact.lastInteractionAt) / (1000 * 60 * 60 * 24)
                            ] : []
                    }["LeadPipeline.useMemo[metrics].avgTimeInPipeline"])) || [];
                    return statusChanges.length > 0 ? Math.round(statusChanges.reduce({
                        "LeadPipeline.useMemo[metrics].avgTimeInPipeline": (a, b)=>a + b
                    }["LeadPipeline.useMemo[metrics].avgTimeInPipeline"], 0) / statusChanges.length) : 0;
                }
            })["LeadPipeline.useMemo[metrics].avgTimeInPipeline"]();
            const hotLeadsInPipeline = (allContacts === null || allContacts === void 0 ? void 0 : allContacts.filter({
                "LeadPipeline.useMemo[metrics]": (c)=>c.leadHeat === 'HOT' && ![
                        'CUSTOMER',
                        'LOST'
                    ].includes(c.status)
            }["LeadPipeline.useMemo[metrics]"]).length) || 0;
            return {
                totalContacts,
    ...
    const handleDragStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LeadPipeline.useCallback[handleDragStart]": (event)=>{
            var _active_data_current;
            const { active } = event;
            const contact = (_active_data_current = active.data.current) === null || _active_data_current === void 0 ? void 0 : _active_data_current.contact;
            if (contact) {
                setActiveContact({
                    id: active.id,
                    contact
    ...
    }["LeadPipeline.useCallback[handleDragStart]"], []);
    const handleDragEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LeadPipeline.useCallback[handleDragEnd]": async (event)=>{
    ...
    }["LeadPipeline.useCallback[handleDragEnd]"], [
        activeContact,
        updateContactStatus
    ]);
    const clearFilters = ()=>{
    ...
    if (allContacts === undefined) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PipelineSkeleton, {}, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DndContext"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: pipelineData.map((column)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PipelineColumn, {
                                column: column,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DragOverlay"], {
                        ...
                        children: activeContact ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "rotate-3 scale-105 shadow-xl",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ContactCard, {
...
_s(LeadPipeline, "3vdudF7/i1Ggc2svspvp8Bw63n0=", false, function() {
    return [
...
function PipelineColumn(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        ref: setNodeRef,
        className: "".concat(column.color, " min-h-[600px] transition-all ").concat(isOver ? 'ring-2 ring-blue-500 ring-opacity-50' : ''),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                className: "pb-3",
                children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        contacts.map((contact)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DraggableContactCard, {
                                contact: contact
                            }, contact._id, false, {
                                fileName: "[project]/src/components/features/leads/LeadPipeline.tsx",
                                lineNumber: 413,
                        ...
                        contacts.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "h-16 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center text-gray-500 text-sm",
...
_s1(PipelineColumn, "DmJTTt6A5xWIX/faBiFge3FOLrw=", false, function() {
    return [
...
_c1 = PipelineColumn;
function DraggableContactCard(param) {
    let { contact } = param;
    _s2();
...
_s2(DraggableContactCard, "eJf23yrfOk1R4KYMcyBjfb2AWDc=", false, function() {
    return [
...
_c2 = DraggableContactCard;
function ContactCard(param) {
    let { contact, isDragging = false } = param;
    const heatStyles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$leadHeatCalculator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeadHeatStylesFromScore"])(contact.leadHeatScore || 0);
    const heatEmoji = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$leadHeatCalculator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHeatEmoji"])(contact.leadHeat);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "cursor-grab active:cursor-grabbing transition-all duration-200 hover:shadow-md ".concat(isDragging ? 'shadow-2xl scale-105 rotate-2 border-blue-300' : ''),
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
            className: "p-4",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-3",
                children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                        variant: "secondary",
                                        className: "text-xs ".concat(heatStyles.badge),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(contact.createdAt), 'MMM d')
                            }, void 0, false, {
                                fileName: "[project]/src/components/features/leads/LeadPipeline.tsx",
                                lineNumber: 525,
                                columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "h-2 rounded-full transition-all ".concat(heatStyles.progress),
                            style: {
                                width: "".concat(Math.min((contact.leadHeatScore || 0) / 25 * 100, 100), "%")
                            }
                        }, void 0, false, {
                            fileName: "[project]/src/components/features/leads/LeadPipeline.tsx",
                            lineNumber: 532,
...
//# sourceMappingURL=src_467382b2._.js.map