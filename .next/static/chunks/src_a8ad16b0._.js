...
function OpportunityCard(param) {
    let { opportunity, isDragging } = param;
    _s();
...
function KanbanColumn(param) {
    let { id, title, color, opportunities } = param;
    _s();
...
_s(OpportunityPipeline, "c1X6TlzzEGD/FiDFFLfDWUXWcDY=", false, function() {
    return [
...
//# sourceMappingURL=src_a8ad16b0._.js.map