...
"[project]/src/components/features/leads/LeadDashboard.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LeadDashboard() {
    ...
    var _getDateRangeStart;
    // Fetch recent interactions for social engagement metrics
    const recentInteractions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$react$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].interactions.getInteractionAnalytics, {
        startDate: (_getDateRangeStart = getDateRangeStart(filters.dateRange)) !== null && _getDateRangeStart !== void 0 ? _getDateRangeStart : undefined,
        endDate: Date.now()
    });
        ...
        "LeadDashboard.useMemo[metrics]": ()=>{
            ...
            if (filters.leadSource) {
                filteredContacts = filteredContacts.filter({
                    "LeadDashboard.useMemo[metrics]": (c)=>c.leadSource === filters.leadSource
                }["LeadDashboard.useMemo[metrics]"]);
            }
            if (filters.leadHeat) {
                filteredContacts = filteredContacts.filter({
                    "LeadDashboard.useMemo[metrics]": (c)=>c.leadHeat === filters.leadHeat
                }["LeadDashboard.useMemo[metrics]"]);
            }
            if (filters.status) {
                filteredContacts = filteredContacts.filter({
                    "LeadDashboard.useMemo[metrics]": (c)=>c.status === filters.status
                }["LeadDashboard.useMemo[metrics]"]);
            }
            ...
            if (dateRangeStart) {
                filteredContacts = filteredContacts.filter({
                    "LeadDashboard.useMemo[metrics]": (c)=>c.createdAt >= dateRangeStart
                }["LeadDashboard.useMemo[metrics]"]);
            }
            // Calculate basic metrics
            const totalLeads = filteredContacts.length;
            const hotLeads = filteredContacts.filter({
                "LeadDashboard.useMemo[metrics]": (c)=>c.leadHeat === 'HOT'
            }["LeadDashboard.useMemo[metrics]"]).length;
            const warmLeads = filteredContacts.filter({
                "LeadDashboard.useMemo[metrics]": (c)=>c.leadHeat === 'WARM'
            }["LeadDashboard.useMemo[metrics]"]).length;
            const coldLeads = filteredContacts.filter({
                "LeadDashboard.useMemo[metrics]": (c)=>c.leadHeat === 'COLD'
            }["LeadDashboard.useMemo[metrics]"]).length;
            const qualifiedLeads = filteredContacts.filter({
                "LeadDashboard.useMemo[metrics]": (c)=>[
                        'QUALIFIED',
                        'CUSTOMER'
                    ].includes(c.status)
            }["LeadDashboard.useMemo[metrics]"]).length;
            const conversionRate = totalLeads > 0 ? qualifiedLeads / totalLeads * 100 : 0;
            const avgHeatScore = totalLeads > 0 ? filteredContacts.reduce({
                "LeadDashboard.useMemo[metrics]": (sum, c)=>sum + (c.leadHeatScore || 0)
            }["LeadDashboard.useMemo[metrics]"], 0) / totalLeads : 0;
            // Generate trends data (last 30 days)
            const trendsData = generateTrendsData(filteredContacts);
            // Calculate source distribution
            const sourceStats = filteredContacts.reduce({
                "LeadDashboard.useMemo[metrics].sourceStats": (acc, contact)=>{
                    acc[contact.leadSource] = (acc[contact.leadSource] || 0) + 1;
                    return acc;
                }
            }["LeadDashboard.useMemo[metrics].sourceStats"], {});
            const sourceDistribution = Object.entries(sourceStats).map({
                "LeadDashboard.useMemo[metrics].sourceDistribution": (param)=>{
            ...
            }["LeadDashboard.useMemo[metrics].sourceDistribution"]).sort({
                "LeadDashboard.useMemo[metrics].sourceDistribution": (a, b)=>b.count - a.count
            }["LeadDashboard.useMemo[metrics].sourceDistribution"]);
            // Calculate status distribution
            const statusStats = filteredContacts.reduce({
                "LeadDashboard.useMemo[metrics].statusStats": (acc, contact)=>{
                    acc[contact.status] = (acc[contact.status] || 0) + 1;
                    return acc;
                }
            }["LeadDashboard.useMemo[metrics].statusStats"], {});
            const statusDistribution = Object.entries(statusStats).map({
                "LeadDashboard.useMemo[metrics].statusDistribution": (param)=>{
            ...
            }["LeadDashboard.useMemo[metrics].statusDistribution"]).sort({
                "LeadDashboard.useMemo[metrics].statusDistribution": (a, b)=>b.count - a.count
            }["LeadDashboard.useMemo[metrics].statusDistribution"]);
            // Calculate heat score distribution
            const heatScoreDistribution = [
                {
                    range: '0-5 (Cold)',
                    count: filteredContacts.filter({
                        "LeadDashboard.useMemo[metrics]": (c)=>(c.leadHeatScore || 0) <= 5
                    }["LeadDashboard.useMemo[metrics]"]).length
                },
                {
                    range: '6-15 (Warm)',
                    count: filteredContacts.filter({
                        "LeadDashboard.useMemo[metrics]": (c)=>(c.leadHeatScore || 0) >= 6 && (c.leadHeatScore || 0) <= 15
                    }["LeadDashboard.useMemo[metrics]"]).length
                },
                {
                    range: '16+ (Hot)',
                    count: filteredContacts.filter({
                        "LeadDashboard.useMemo[metrics]": (c)=>(c.leadHeatScore || 0) >= 16
                    }["LeadDashboard.useMemo[metrics]"]).length
                }
            ];
            ...
            const socialEngagementMetrics = {
                ...
                topPlatforms: Object.entries(recentInteractions.interactionsByPlatform || {}).map({
                    "LeadDashboard.useMemo[metrics]": (param)=>{
                        let [platform, interactions] = param;
                        return {
                            platform,
                            interactions
                        };
                    }
                }["LeadDashboard.useMemo[metrics]"]).sort({
                    "LeadDashboard.useMemo[metrics]": (a, b)=>b.interactions - a.interactions
                }["LeadDashboard.useMemo[metrics]"]).slice(0, 5),
    ...
    const exportData = ()=>{
        ...
        const csvData = allContacts === null || allContacts === void 0 ? void 0 : allContacts.map((contact)=>({
                Name: contact.name,
                Email: contact.email,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                            ...
                                            onValueChange: (value)=>setFilters((prev)=>({
                                                        ...prev,
                                                        leadHeat: value === 'all' ? undefined : value
                                                    })),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectTrigger"], {
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectValue"], {}, void 0, false, {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$PieChart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PieChart"], {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$polar$2f$Pie$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Pie"], {
                                                    ...
                                                    cy: "50%",
                                                    labelLine: false,
                                                    label: (entry)=>"".concat(entry.source, ": ").concat(entry.count),
                                                    outerRadius: 80,
                                                    fill: "#8884d8",
                                                    dataKey: "count",
                                                    children: metrics.sourceDistribution.map((entry, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$component$2f$Cell$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Cell"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$component$2f$ResponsiveContainer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveContainer"], {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$BarChart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BarChart"], {
                                            data: metrics.heatScoreDistribution,
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$cartesian$2f$CartesianGrid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CartesianGrid"], {
                                                    strokeDasharray: "3 3"
                                                }, void 0, false, {
...
_s(LeadDashboard, "7vt1L0XegKPv7jisL0fdMHcDONc=", false, function() {
    return [
...
function MetricCard(param) {
    let { title, value, icon, trend, trendDirection, color } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
            className: "p-6",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            trend && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center text-sm ".concat(trendDirection === 'up' ? 'text-green-600' : 'text-red-600'),
                                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "".concat(getColorClass(color)),
                        children: icon
                    }, void 0, false, {
                        fileName: "[project]/src/components/features/leads/LeadDashboard.tsx",
                        lineNumber: 553,
...
function generateTrendsData(contacts) {
...
function generateEngagementTrend(interactions) {
...
//# sourceMappingURL=src_311ef8c2._.js.map