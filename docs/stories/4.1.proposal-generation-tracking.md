...
- [ ] **Task 1: Proposal Data Model and API Layer** (AC: 1, 2)
  - [ ] Extend Convex schema with proposals, proposalTemplates, and proposalInteractions tables
  - [ ] Create Convex proposal functions with CRUD operations, status management, and validation
  - [ ] Implement proposal-opportunity relationship management and status synchronization
  - [ ] Add database indexes for efficient proposal querying and filtering

- [ ] **Task 2: Document Template System** (AC: 3)
  - [ ] Build template management interface with rich text editor
  - [ ] Create dynamic field system for opportunity data injection
  - [ ] Implement template versioning and revision control
  - [ ] Add template preview functionality with sample data
  - [ ] Support event-type specific template organization
