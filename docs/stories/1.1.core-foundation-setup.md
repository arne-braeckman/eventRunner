...
**I want** to establish the foundational T3 Stack infrastructure with Convex database and authentication,
...
3. Convex Auth is configured with OAuth providers (Google, GitHub)
...
- [ ] Task 1: Initialize T3 Stack Application (AC: 1)

  - [ ] Create T3 app with Next.js 14, TypeScript, tRPC, Tailwind CSS
  - [ ] Configure initial project structure per architecture guidelines
  - [ ] Verify Next.js 14 App Router is properly configured

- [ ] Task 2: Set up Convex Database and Functions (AC: 2)

  - [ ] Install and configure Convex CLI
  - [ ] Create Convex schema with User and Contact models
  - [ ] Set up database functions for user and contact operations
  - [ ] Configure development environment variables

- [ ] Task 3: Implement Convex Auth (AC: 3)
...
- [ ] Task 5: Create Basic Lead Capture Form (AC: 5)

  - [ ] Create lead capture form component with validation
  - [ ] Implement Contact model in Convex schema
  - [ ] Create contact creation function
  - [ ] Connect form to Convex mutations
